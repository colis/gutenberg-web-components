...
if ( ! defined( 'GUTENBERG_WEB_COMPONENTS_DIR' ) ) {
	define( 'GUTENBERG_WEB_COMPONENTS_DIR', __DIR__ . '/' );
}
...
if ( ! defined( 'GUTENBERG_WEB_COMPONENTS_PATH' ) ) {
	define( 'GUTENBERG_WEB_COMPONENTS_PATH', 'path' );
}
